...
class CharacterEncoderTest(unittest.TestCase):
    ...
    def testNumRowsWithPadding(self):
        for text in ['This is English', '谢谢你', u'ko\u017eu\u0161\u010dek']:
            ...
            self.assertEqual(character_encoder.NUM_ROWS, len(result))
    ...
    @staticmethod
    def _getRange(row: bytes, left_index_included: int, right_index_included: int):
    ...
    def testAwkwardRangeHelperFunction(self):
        self.assertEqual(b'456', self._getRange(b'123456789', 4, 6))
